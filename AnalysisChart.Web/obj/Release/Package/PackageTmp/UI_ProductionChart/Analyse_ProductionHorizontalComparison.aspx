...
<body>
        ...
        <div class="easyui-panel" data-options="region:'west',border:true" style="width: 260px;">
            <table id="tool_SelectedObj" style="display: none; width: 260px;">
                ...
                <tr>
                    ...
                    <td style="text-align: left; width: 190px;" colspan="2">
                        <select id="ComboTree_ValueTypeF" class="easyui-combotree" name="ValueType" data-options="panelHeight:'auto'" style="width: 176px;">
                        </select>
                    </td>
                </tr>
                <tr>
    ...
    <div id="toolbar_StaticsItems" style="display: none;">
        <table>
            <tr>
                <td>设备名称：</td>
                <td>
                    <input id="EquipmentCommonInfo" class="easyui-combobox" readonly="readonly" style="width: 100px" />
                </td>
                <td><a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="loadEquipmentInfo()">查询</a></td>
            </tr>
        </table>
    </div>
