<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Analyse_EntityBenchmarking.aspx.cs" Inherits="AnalysisChart.Web.UI_AnalysisChart.Analyse_EntityBenchmarking" %>

<%@ Register Src="~/UI_WebUserControls/TagsSelector/TagsSelector_Dcs.ascx" TagName="TagsSelector_Dcs" TagPrefix="uc1" %>
<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head_EntityBenchmarking" runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>工序能耗KPI分析</title>
    ...
    <script type="text/javascript" src="js/page/Analyse_EntityBenchmarking.js" charset="utf-8"></script>
                ...
                <table style="width: 330px;">
                    <tr>
                        ...
                        <td style="text-align: left;" colspan="2">
                            <input type="radio" name="SelectRadio_Cyc" id="Radio_YearStatistics" value="year" />年统计
                            <input type="radio" name="SelectRadio_Cyc" id="Radio_MonthStatistics" value="month" checked="checked" />月统计
                            <input type="radio" name="SelectRadio_Cyc" id="Radio_CustomDefineStatistics" value="CustomDefine" />自定义日统计
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;" colspan="2">
                            <select id="Combobox_ValueTypeF" class="easyui-combobox" name="ValueType" data-options="panelHeight:'auto'" style="width: 135px;">
                                <option value="ElectricityQuantity">工序电量</option>
                                <option value="ElectricityConsumption">工序电耗</option>
                                <option value="CoalConsumption">工序煤耗</option>
