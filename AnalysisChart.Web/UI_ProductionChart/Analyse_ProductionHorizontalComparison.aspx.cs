...
{
    public partial class Analyse_ProductionHorizontalComparison : WebStyleBaseForEnergy.webStyleBase
    {
        ...
        {
            string myValueJson = AnalysisChart.Bll.Analyse_ProductionHorizontalComparison.GetHorizontalComparisonDataValue(myStartTime, myEndTime, myTagInfoJson);
            return myValueJson;
        }
        [WebMethod]
